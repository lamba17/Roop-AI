...
export const DERMATOLOGISTS: Record<string, Dermatologist[]> = {
  ...
  Mumbai: [
    ...
    { name: 'Dr. Niteen Dhepe', clinic: 'Skin City, Pune Road, Mumbai', rating: 4.7, specialty: 'Vitiligo & Hair Loss', googleMapsLink: 'https://maps.google.com/?q=Skin+City+Mumbai', priceRange: '₹700 – ₹1,800' },
